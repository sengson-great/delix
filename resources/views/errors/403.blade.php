...
<main class="error-page">
    <div class="container">
        ...
        <div class="error-page__heading">
            <h1 class="error-page__heading-title">Looks like you don't have permission to access</h1>
            <p class="error-page__heading-desciption">403 error</p>
        </div>

        <a class="error-page__button" href="{{url('/')}}" aria-label="back to home" title="back to home">back to home</a>
    </div>
    </div>
