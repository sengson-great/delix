                                ...
                                <div class="text-nowrap table-responsive">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{__('phone')}}</td>
                                                <td>{{ (isDemoMode() ? '**************' : ( $merchant->phone_number ?? ''))  }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($merchant->registration_confirmed == 1)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ getFileLink('80X80', $merchant->trade_license) }}">
                                                        <span class="tb-status text-info">{{ $merchant['trade_license'] ? getFileLink('80X80', $merchant->trade_license) : __('not_available') }}
                                                            @php
