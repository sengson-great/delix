    ...
    <div class="container-fluid">
        <div class="row">
                            ...
                            <div class="profit clr-1">
                                <div class="profit-icon p-4">
                                    ...
                                    <div class="profit-content no-line-braek">
                                        <h4 class="own-balance">{{ $branch_balance }}</h4>
                                        <p>{{ __('current_balance') }}</p>
                                    </div>
                            </div>
                            <div class="text-center no-line-braek">
                            <a href="{{ route('staff.payment.logs') }}" class="btn btn-sm sg-btn-primary gap-1 px-4 mt-20 mb-20">
            ...
            <div class="col-xxl-9 col-xl-9 col-md-12">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="analytics clr-4">
                                    ...
                                    <div class="analytics-content no-line-braek">
                                        <h4>{{ $branch_wise_total_merchant }}</h4>
                                        <p>{{__('merchant')}}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-md-6">
                        <div class="statistics-card bg-white redious-border mb-4 p-20 p-sm-30">
                            <div class="analytics clr-5">
                                ...
                                <div class="analytics-content no-line-braek">
                                    <h4>{{ $pending_pickup }}</h4>
                                    <p>{{__('pending_pickup')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-xl-4 col-md-6">
                        <div class="statistics-card bg-white redious-border mb-4 p-20 p-sm-30">
                            <div class="return clr-6">
                                <div class="return-icon">
                                    <i class="las la-undo-alt"></i>
                                </div>

                                <div class="return-content no-line-braek">
                                    <h4 class="red-line">{{ format_price($cash_in) }}</h4>
                                    <p>{{__('cash_in')}}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="analytics clr-1 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        <p>{{ __('new_parcel') }}</p>
                                        <h4 id="new_parcel">{{ $branch_wise_total_new_parcel . '/' . setting('default_currency') . $branch_wise_total_new_parcel_cod }}</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="analytics clr-2 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        ...
                                        <h4 id="processing_parcel">{{ $branch_wise_total_processing_parcel . '/' . setting('default_currency') . $branch_wise_total_processing_parcel_cod }}</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="analytics clr-4 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        <p>{{ __('delivered') }}</p>
                                        <h4 id="delivered_parcel">{{ $branch_wise_total_delivered_parcel . '/' . setting('default_currency') . $branch_wise_total_delivered_parcel_cod}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-6 col-md-12">
                <div class="statistics-card bg-white redious-border mb-4 pt-20 p-30 flex-column h-100 d-flex">
                    ...
                    <div class="statistics-report-chart custom-report">
                        <canvas id="parcel_statistic" class="income-custom-report"></canvas>
                    </div>
                </div>
            </div>
        </div>
        <div class="row ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        @foreach ($latest_parcels as $latest_parcel)
                                                            <tr>
                                                                <td>
                                                                    <div class="user-name">
                                                                        <a href="{{ route('merchant.parcel.detail', $latest_parcel->id) }}">
                                                                            <span class="d-block">{{ __('id') }}:#{{ $latest_parcel->parcel_no }}</span>
                                                                            <span class="d-block">{{ __('invno') }}:{{ $latest_parcel->customer_invoice_no }}</span>
                                                                        </a>

                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span>{{ $latest_parcel->customer_name }}</span>
                                                                </td>
                                                                <td>
                                                                    <span>{{ $latest_parcel->customer_phone_number }}</span>
                                                                </td>
                                                                <td>
                                                                    <span class="tb-sub">{{ __($latest_parcel->location) }}</span>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
            ...
            <div class="col-lg-12 col-xxl-6">
                <div class="bg-white redious-border mb-4 pt-20 p-30">
                    <div class="section-top mb-2">
                        <h4>{{ __('recent_delivered_parcel') }}</h4>
                    </div>
                    <div id="best_selling_table_container">
                        <section class="oftions">
                            <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        @foreach ($latest_delivery_parcels as $latest_delivery_parcel)
                                                            <tr>
                                                                <td>
                                                                    <div class="user-name">
                                                                        <a href="{{ route('merchant.parcel.detail', $latest_delivery_parcel->id) }}">
                                                                            <span class="d-block">{{ __('id') }}:#{{ $latest_delivery_parcel->parcel_no }}</span>
                                                                            <span class="d-block">{{ __('invno') }}:{{ $latest_delivery_parcel->customer_invoice_no }}</span>
                                                                        </a>

                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span>{{ $latest_delivery_parcel->customer_name }}</span>
                                                                </td>
                                                                <td>
                                                                    <span>{{ $latest_delivery_parcel->customer_phone_number }}</span>
                                                                </td>
                                                                <td>
                                                                    <span class="tb-sub">{{ __($latest_delivery_parcel->location) }}</span>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
            ...
            $(document).on('click', '.__js_parcel_filterable_item', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#new_parcel').text(response.data.branch_wise_total_new_parcel + '/' + currency +response.data.branch_wise_total_new_parcel_cod);
                        $('#processing_parcel').text(response.data.branch_wise_total_processing_parcel + '/' + currency +response.data.branch_wise_total_processing_parcel_cod);
                        $('#delivered_parcel').text(response.data.branch_wise_total_delivered_parcel + '/' + currency +response.data.branch_wise_total_delivered_parcel_cod);
