        ...
        <div class="row justify-content-md-center">
            <div class="col-12 col-lg-6 col-md-6">
                <div class="header-top d-flex justify-content-between align-items-center mb-12">
                    <h3 class="section-title">{{ __('add') }} {{ __('credit_from_merchant') }}</h3>
                    <div class="oftions-content-right">
                        <a href="{{ url()->previous() }}" class="d-flex align-items-center btn sg-btn-primary gap-2">
                            <i class="icon las la-arrow-left"></i>
                            <span>{{ __('back') }}</span>
                        </a>
                    </div>
                </div>
                <form action="{{ route('incomes.receive.from.merchant.store') }}" class="form-validate" method="POST"
                                ...
                                <div class="card-inner">
                                    <div class="mb-3">
                                        ...
                                        <select id="merchant-live-search" name="merchant"
                                            class=" select-merchant-for-credit merchant-live-search @error('merchant') is-invalid @enderror">
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="mamount">{{ __('amount') }}
                                            ({{ (setting('default_currency'))  }}) <span
                                                class="text-danger">*</span></label>
                                        <input type="number" class="form-control @error('amount') is-invalid @enderror"
                                            id="mamount" value="{{ old('amount') }}" name="amount">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="details"
                                            placeholder="{{ __('details') . ' (' . __('optional') . ')' }}"
