                            ...
                            <div class="col-md-12">
                                <div class="card-inner">
                                    <div class="mb-3">
                                        ...
                                        <select id="merchant-live-search" name="merchant"
                                            ...
                                            {{-- <select class=" form-control select-merchant-for-credit"
                                                data-url="{{ route('admin.merchant.parcel') }}" name="merchant"> --}}
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="mamount">{{ __('amount')}}
                                        ({{ (setting('default_currency'))  }}) <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control date-picker @error('date') is-invalid @enderror"
