                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <div class="default-tab-list default-tab-list-v2 bg-white redious-border activeItem-bd-none p-20 p-sm-30">
                        <div class="d-flex justify-content-between align-items-center mb-12">
                            ...
                            <div>
                                @if(hasPermission('merchant_staff_create'))
                                    <a href="{{ route('detail.merchant.staff.create', $merchant->id) }}"  class="btn sg-btn-primary align-items-center gap-1 d-md-inline-flex"><i class="las la-plus"></i><span>{{__('add')}}</span></a>
                                @endif
                            </div>
                        </div>
                        <div class="row">
