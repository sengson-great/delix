            ...
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <div class="header-top d-flex justify-content-between align-items-center">
                        <h3 class="section-title">{{ __('news_and_event') }}</h3>
                        <div class="oftions-content-right mb-12">
                            <a href="{{ route('news-and-events.create') }}" class="d-flex align-items-center btn sg-btn-primary gap-2">
                                <i class="las la-plus"></i>
                                <span>{{__('add_news_and_event') }}</span>
                            </a>
                        </div>
                    </div>
                    <div class="row">
