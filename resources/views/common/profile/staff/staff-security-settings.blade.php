            ...
            <div class="row">
                ...
                <div class="col-xxl-9 col-lg-8 col-md-8">
                    <div
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('staff.change-password') }}" class="form-validate" method="POST"
                                      enctype="multipart/form-data" id="change-password-form">
                                    @csrf
                                    <div class="gy-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="current_password" class="form-control"
                                                   id="full-current_password" placeholder="{{ __('current_password') }}"
                                                   required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label"
                                                   for="full-new_password">{{ __('new_password') }}</label>
                                            <input type="password" name="new_password" class="form-control"
                                                   id="full-new_password"
        ...
        $(document).ready(function () {
            $('#change-password-form').on('submit', function () {
                if ($('#full-new_password').val() != $('#full-confirm_new_password').val()) {
                    toastr.clear();
                    toastr.error('{{ __('new_passwords_do_not_match.') }}');
                    return false;
                }
            });
        });
