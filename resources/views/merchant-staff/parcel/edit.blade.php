            ...
            <div class="col-lg-12">
                <div class="header-top d-flex justify-content-between align-items-center">
                        ...
                        <div class="oftions-content-right">
                            <a href="{{ url()->previous() }}" class="btn sg-btn-primary d-none d-md-inline-flex"><i
                                    class="icon las la-arrow-left"></i><span>{{ __('back') }}</span></a>
                        </div>
                </div>
                <form action="{{ route('merchant.parcel.update') }}" class="form-validate" method="POST"
                            ...
                            <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30">
                                <div class="row g-gs">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="fv-full-name">{{ __('weight') }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="fv-full-name">{{ __('cod') . ' ' . __('amount') }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="area">{{ __('delivery_area') }}
                                                ...
                                                <select
                                                    class="form-select form-control form-control-lg parcel_type"
                                                    name="parcel_type">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="area">{{ __('shop') }}
                                                ...
                                                <select
                                                    class="form-select form-control form-control-lg select-shop"
                                                    data-url="{{ route('merchant.staff.shop') }}" name="shop">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label"
                                            ...
                                            <input type="text" class="form-control @error('pickup_branch_id') is-invalid @enderror"
                                                ...
                                                value="{{ @$parcel->pickupBranch->name ? @$parcel->pickupBranch->name  : ''  }}"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="{{ $parcel->pickup_shop_phone_number }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <textarea class="form-control" id="customer_address" placeholder="{{ __('recipient') . ' ' . __('address') }}" required
                                    ...
                                    <div
                                        class="col-md-6 packaging-area {{ $parcel->fragile == 0 ? 'd-none' : '' }}">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="fv-full-name">{{ __('packaging') }}</label>
                                                <select
                                                    class="form-select form-control form-control-lg packaging"
                                                    name="packaging">
                                                    ...
                                                    @foreach (settingHelper('package_and_charges') as $package_and_charge)
                                                        <option value="{{ $package_and_charge->id }}"
                                                            ...
                                                            ({{ format_price($package_and_charge->charge) }})</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col"><span
                                                        class="sub-text"><strong>{{ __('amount') }}</strong></span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="cash-collection-charge">{{ format_price($parcel->price) }}</span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="delivery-charge">{{ format_price($parcel->charge) }}</span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="cod-charge">{{ format_price(floor(($parcel->price / 100) * $parcel->cod_charge)) }}</span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="vat-charge">{{ format_price((floor($parcel->charge + $parcel->fragile_charge + $parcel->packaging_charge + ($parcel->price / 100) * $parcel->cod_charge) / 100) * $parcel->vat) }}</span>
                                                </div>
                                            </div>
                                            <div
                                                class="nk-tb-item fragile-charge-area {{ $parcel->fragile == 0 ? 'd-none' : '' }}">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="fragile-charge">{{ format_price($parcel->fragile_charge) }}</span>
                                                </div>
                                            </div>
                                            <div
                                                class="nk-tb-item packaging-charge-area {{ $parcel->packaging == 'no' ? 'd-none' : '' }} ">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="packaging-charge">{{ format_price($parcel->packaging_charge) }}</span>
                                                </div>
                                            </div>
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col">
                                                    <span
                                                        id="total-delivery-charge">{{ format_price($parcel->total_delivery_charge) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="nk-tb-item nk-tb-head">
                                                ...
                                                <div class="nk-tb-col"><span class="sub-text"><strong
                                                            id="current-payable-charge">{{ format_price($parcel->payable) }}</strong></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
