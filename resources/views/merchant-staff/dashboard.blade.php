                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="analytics-content mb-1">
                                <h4 class="no-line-braek">{{__('hello')}}
                                    {{ \Sentinel::getUser()->first_name . ' ' . \Sentinel::getUser()->last_name }},</h4>
                                <p class="no-line-braek">{{ __('we_re_thrilled_to_have_you_at') }}
                                    {{ setting('system_name') }}.</p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="text-center no-line-braek">
                                <a href="{{ route('merchant.withdraw') }}"
                                    class="btn btn-sm sg-btn-primary gap-1 px-4 mt-20 mb-20">
                ...
                <div class="statistics-card bg-white redious-border mb-4 pt-20 p-30 flex-column h-100 d-flex">
                    <div class="section-top">
                        ...
                        <div class="statistics-view dropdown pe-4">
                            <a href="#" class="dropdown-toggle dropdown-item" data-bs-toggle="dropdown" id="today"
                                aria-expanded="false">
                                {{ __('today') }}
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item __js_parcel_filterable_item" data-filter="last_month"
                                        id="last_month" href="#">
                                        {{ __('last_month') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item __js_parcel_filterable_item" data-filter="last_6_month"
                                        id="last_6_month" href="#">
                                        {{ __('last_6_month') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item __js_parcel_filterable_item" data-filter="this_year"
                                        id="this_year" href="#">
                                        {{ __('this_year') }}
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item __js_parcel_filterable_item" data-filter="last_12_month"
                                        id="last_12_month" href="#">
                                        {{ __('last_12_month') }}
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="col-md-4">
                                <div class="analytics clr-1 mb-40">
                                    ...
                                    <div class="analytics-content">
                                        <p>{{ __('new_parcel') }}</p>
                                        <h4 id="new_parcel">
                                            {{ $new_parcel . '/' . setting('default_currency') . $new_parcel_cod }}</h4>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        @foreach ($latest_parcels as $parcel)
                                                            <tr>
                                                                <td>
                                                                    <div class="user-name">
                                                                        <a class="opacity-75"
                                                                            href="{{ route('merchant.parcel.detail', $parcel->id) }}">
                                                                            <span
                                                                                class="d-block">{{ __('id') }}:#{{ $parcel->parcel_no }}</span>
                                                                            <span
                                                                                class="d-block">{{ __('invno') }}:{{ $parcel->customer_invoice_no }}</span>
                                                                        </a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        @foreach (Sentinel::getUser()->staffMerchant->withdraws->take(5) as $withdraw)
                                                            <tr>
                                                                <td>
                                                                    <span
                                                                        class="title text-info">{{ $withdraw->withdraw_id }}</span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="amount text-success">
                                                                        {{ format_price($withdraw->amount) }}</div>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
