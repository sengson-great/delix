...
!function (NioApp, $) {
  ...
  NioApp.CurrentLink = function () {
    var _link = '.nk-menu-link, .menu-link, .nav-link',
        ...
        if(fileName.indexOf('admin/transactions') != -1 || fileName.indexOf('admin/search-parcels') != -1) {

          if(fileName.indexOf('admin/transactions') != -1){
            $("#transaction-history-sub").addClass('active current-page');
            $("#report-main").addClass("active current-page");
            $("#transaction-history-sub").children('.nk-menu-sub').css('display', 'block');
            $("#report-main").children('.nk-menu-sub').css('display', 'block');
          }else{
            $("#transaction-history-sub").removeClass('active current-page');
          }

          if(fileName.indexOf('admin/search-parcels') != -1){
            $("#parcel-summery-sub").addClass('active current-page');
            $("#report-main").addClass("active current-page");
            $("#parcel-summery-sub").children('.nk-menu-sub').css('display', 'block');
            $("#report-main").children('.nk-menu-sub').css('display', 'block');
          }else{
            $("#parcel-summery-sub").removeClass('active current-page');
          }
    ...
    if(count == 0){
      ...
      if(fileName.indexOf('admin/transactions') != -1 || fileName.indexOf('admin/search-parcels') != -1 || fileName.indexOf('admin/search-income-expense') != -1) {
        ...
        if(fileName.indexOf('admin/search-income-expense') != -1){
          $("#income-expense-sub").addClass('active current-page');
          $("#report-main").addClass("active current-page");
          $("#income-expense-sub").children('.nk-menu-sub').css('display', 'block');
          $("#report-main").children('.nk-menu-sub').css('display', 'block');
        }else{
          $("#income-expense-sub").removeClass('active current-page');
        }
